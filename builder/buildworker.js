                    ...
                    if (matches){
                        ...
                        if (version){
                            ...
                            var fsTasks = [
                                ...
                                , [exec, [["cd", pdir, "&&", python, "setup.py", "nosetests", "--extra-index-url", "https://www.ideafreemonoid.org/pip", "--verbosity=1", "--with-coverage", "--cover-package="+dist_name, "--cover-erase"].join(" ")], undefined, function (err, stdout, stderr){
                                    test_results = stderr;
                                }]
